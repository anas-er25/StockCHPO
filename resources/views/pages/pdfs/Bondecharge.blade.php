...
<head>
    ...
    <style>
        ...
        .header img {
            width: 100%; /* Ajustez la largeur de l'image de l'en-tête */
            max-width: 800px; /* Limitez la largeur maximale */
            height: auto; /* Gardez le ratio de l'image */
        }

        .footer img {
            width: 100%; /* Ajustez la largeur de l'image du pied de page */
            max-width: 800px; /* Limitez la largeur maximale */
            height: auto; /* Gardez le ratio de l'image */
