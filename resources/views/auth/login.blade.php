...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('/public/assets/images/logos/favicon.png') }}" type="image/x-icon">
...
<body class="font-sans antialiased">
    <div class="font-sans antialiased">
        ...
        <div class="flex items-center justify-center min-h-screen" style="background-image: url('https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80'); background-size: cover; background-position: center;">
