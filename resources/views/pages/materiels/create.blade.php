                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="type" id="type" required
                                        class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        <option value="hospitalier" {{ old('type') == 'hospitalier' ? 'selected' : '' }}>
                                            Hospitalier</option>
                                ...
                                <div>
                                    ...
                                    <select name="origin" id="origin" required
                                        ...
                                        <option value="don" {{ old('origin') == 'don' ? 'selected' : '' }}>Don</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="etat" id="etat" required
                                        class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        <option value="réceptionné" {{ old('etat') == 'réceptionné' ? 'selected' : '' }}>
                                            Réceptionné</option>
                                        <option value="affecté" {{ old('etat') == 'affecté' ? 'selected' : '' }}>Affecté
                                        </option>
                                        <option value="en mouvement"
                                            {{ old('etat') == 'en mouvement' ? 'selected' : '' }}>En mouvement</option>
                                        <option value="réformé" {{ old('etat') == 'réformé' ? 'selected' : '' }}>Réformé
                                        </option>
                                    </select>
