...
class MaterialHistoryController extends Controller
{
    ...
    {
        // Récupérer le N° d'inventaire depuis la requête AJAX
        ...
        // Si un N° d'inventaire est fourni, rechercher l'historique
        if ($inventoryNumber) {
            // Extraire le N° d'inventaire sans l'année
            $inventoryNumberWithoutYear = preg_replace('/\/\d+$/', '', $inventoryNumber);

            // Trouver le matériel correspondant au N° d'inventaire
